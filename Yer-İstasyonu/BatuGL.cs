...
namespace Yer_İstasyonu
{
    public static class BatuGL
    {
        ...
        public static void Configure(OpenTK.GLControl refGLControl, Ortho_Mode ortho)
        {
            ...
            // Eksenlerin yerlerini değiştirelim
        ...
        public static void Draw_WCS(float size = 1000.0f)
        {
            ...
            // X ekseni pozitif
            GL.Color3(Color.Red);  // X ekseni kırmızı renkte
            ...
            // Y ekseni pozitif
            GL.Color3(Color.Green);  // Y ekseni yeşil renkte
            GL.Vertex3(0.0f, 0.0f, 0.0f);
            ...
            // Z ekseni pozitif
            GL.Color3(Color.Blue);  // Z ekseni mavi renkte
            GL.Vertex3(0.0f, 0.0f, 0.0f);
        ...
        public class VAO_TRIANGLES
        {
            ...
            public void Draw()
            {
                ...
                GL.DisableClientState(ArrayCap.IndexArray); //normalArray
